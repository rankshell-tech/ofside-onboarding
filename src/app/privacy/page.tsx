...
const PrivacyPolicyPage = () => (
    <main className="min-h-screen bg-gray-50 py-8 px-4 md:px-12">
        <section data-reveal="feature-card" className="mb-8 p-6 bg-white rounded-xl shadow">
            ...
            <p>
                Ofside (Rankshell Private Limited) (&quot;Ofside&quot;, &quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is committed to protecting the privacy of our users (&quot;you&quot;, &quot;your&quot;). This Privacy Policy explains how we collect, use, disclose, and safeguard your personal and non-personal information when you access or use our sports app, website, mobile applications, and related services (collectively, the &quot;Services&quot;). Paid features are offered only through <strong>app Subscriptions</strong> (Ofside Pro). By using the Services, you consent to the practices described in this Policy.
            </p>
        </section>
        ...
        <section data-reveal="feature-card" className="mb-8 p-6 bg-white rounded-xl shadow">
            ...
            <ul className="list-disc pl-6 mb-3 space-y-1">
                ...
                <li><strong>With Your Consent:</strong> Any other sharing when you explicitly agree.</li>
            </ul>
            <p>
                <span className="bg-gray-100 px-4 py-2 rounded inline-block">
                    We do not sell, trade, or rent Personal Information to unaffiliated Third Parties for marketing purposes.
                </span>
            </p>
        </section>
        ...
        <section data-reveal="feature-card" className="mb-8 p-6 bg-white rounded-xl shadow">
            ...
            <p>
                However, no system is completely secure. We cannot guarantee absolute protection against unauthorized access or breaches.
            </p>
        </section>
