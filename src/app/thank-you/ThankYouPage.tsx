      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 24px #43EA7F44, 0 2px 8px #00000022",
            animation: "pop 0.6s cubic-bezier(.68,-0.55,.27,1.55)",
          }}
        >
          <svg width="54" height="54" viewBox="0 0 60 60" fill="none">
            <circle cx="30" cy="30" r="28" stroke={BRAND_PRIMARY} strokeWidth="4" fill="none" opacity="0.08" />
            <polyline
        ...
        <h1 className="text-3xl font-extrabold mb-3" style={{ color: BRAND_PRIMARY, letterSpacing: "-0.5px" }}>
          Thank You!
        </h1>
        ...
        <div className="flex items-center justify-center text-sm text-gray-700 gap-3">
          <a href="mailto:Partnercare@ofside.in" className="underline" style={{ color: "#1976d2" }}>
