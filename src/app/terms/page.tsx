...
const TermsPage = () => (
    <main className="min-h-screen bg-gray-50 py-8 px-4 md:px-12">
        ...
        <SectionBox>
            ...
            <p className="mb-2">
                <strong>Binding Agreement.</strong> These Terms of Use, Privacy Policy, and Subscription Cancellation &amp; Refund Policy (collectively, &quot;Policies&quot;) constitute a binding agreement between you and Ofside (Rankshell Private Limited) (&quot;Ofside&quot;, &quot;we&quot;, &quot;us&quot;).
            </p>
            <p className="mb-2">
